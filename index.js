(function(){
    ...
    // Para almacenar la configuracion actual
    var juego = null
    ...
    function alertaGanado() {
      swal("¡Felicidades, ganaste!", "Si quiere continuar jugando, haga click en el boton: 'Nuevo Juego'");
    }
